...
const PROVIDER_POLICIES = Object.freeze([
  {
    ...
    requiresAudit: true,
    sensitiveFields: ['accessToken', 'refreshToken', 'appKey', 'appSecret', 'customerPhone', 'receiverAddress'],
    redactionRules: {
  ...
  },
  {
    ...
    requiresIdempotency: true,
    requiresAudit: true,
    sensitiveFields: ['appId', 'appSecret', 'userEid', 'customerName', 'customerPhone', 'idCardNo'],
    redactionRules: {
      appId: 'mask',
      appSecret: 'never-log',
      userEid: 'mask',
  ...
  },
  {
    ...
    requiresIdempotency: true,
    requiresAudit: true,
    sensitiveFields: ['accessToken', 'refreshToken', 'cookie', 'sellerId', 'buyerPhone'],
    redactionRules: {
      accessToken: 'hash-only',
      refreshToken: 'hash-only',
      cookie: 'never-log',
